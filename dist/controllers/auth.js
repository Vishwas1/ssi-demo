...
var sha256hashStr = require('../../../explorer/src/crypto-lib/symmetric.js').sha256hashStr;
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 6:
                ...
                jsonwebtoken_1.default.sign(userData_1, config_1.jwtSecret, { expiresIn: config_1.jwtExpiryInMilli }, function (err, token) {
                    if (err)
                        throw new Error(err);
...
var getNewChallenge = function (req, res) {
    ...
    jsonwebtoken_1.default.sign({ challenge: challenge }, config_1.jwtSecret, { expiresIn: config_1.jwtExpiryInMilli }, function (err, token) {
        if (err)
            throw new Error(err);
        res.status(200).send({ status: 200, message: {
                JWTChallenge: token,
