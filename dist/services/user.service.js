...
var User = /** @class */ (function () {
    function User(_a) {
        var _b = _a.id, id = _b === void 0 ? " " : _b, _c = _a.fname, fname = _c === void 0 ? "" : _c, _d = _a.lname, lname = _d === void 0 ? "" : _d, _e = _a.username, username = _e === void 0 ? "" : _e, _f = _a.phoneNumber, phoneNumber = _f === void 0 ? "" : _f, _g = _a.password, password = _g === void 0 ? "" : _g, _h = _a.email, email = _h === void 0 ? "" : _h, publicKey = _a.publicKey, _j = _a.privateKey, privateKey = _j === void 0 ? "" : _j, _k = _a.hash, hash = _k === void 0 ? "" : _k, _l = _a.birthdate, birthdate = _l === void 0 ? "" : _l, _m = _a.jobTitle, jobTitle = _m === void 0 ? "" : _m;
        this.id = id; // new uuid
        this.fname = fname;
        this.lname = lname;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.dbSerice.add(db_service_1.SchemaType.User, this)];
                    case 1:
                        newUser = _a.sent();
